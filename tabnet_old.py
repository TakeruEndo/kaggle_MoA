...
if __name__ == '__main__':
    ...
    if decompo == "PCA":
        ...
        pca_genes = TruncatedSVD(n_components = ncompo_genes,
                        random_state = seed).fit_transform(data_all[GENES])
        pca_cells = TruncatedSVD(n_components = ncompo_cells,
        ...
        data_all = pd.concat([data_all, pca_genes, pca_cells, svd], axis = 1)
    else:
        pass
